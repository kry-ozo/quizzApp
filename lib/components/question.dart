  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          Container(
            child: Text(quizz.question, style: const TextStyle(color: const Color.fromARGB(255, 255, 250, 255), fontSize: 24), textAlign: TextAlign.center),
            width: MediaQuery.of(context).size.width,
          ...
          Column(
            ...
            children: quizz.allAnswears.map((answear)=> Container(
              width: MediaQuery.of(context).size.width,
              decoration: const BoxDecoration(
